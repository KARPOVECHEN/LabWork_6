...
public class StudentsGroup {
    ...
    private static ArrayList<StudentsGroup> groups=new ArrayList<StudentsGroup>(Arrays.asList(
            ...
            new StudentsGroup("ІПЗ19-1","Інженерія програмного забезпечення",1,false,true),
            new StudentsGroup("308","Кібербезпека",0,true,true),
            new StudentsGroup("309","Кібербезпека",0,false,true)
    ));
